...
class BaseFilter(object):
    title = None
    template = 'opps/admin/filters/list.html'
...
class TextFieldListFilter(FieldFilter):
    template = 'opps/admin/filters/char.html'
...
class NumberFieldListFilter(FieldFilter):
    template = 'opps/admin/filters/number.html'
...
class DateFieldListFilter(ListFieldFilter):
    template = 'opps/admin/filters/date.html'
...
class RelatedFieldSearchFilter(FieldFilter):
    template = 'opps/admin/filters/fk_search.html'
