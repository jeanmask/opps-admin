...
from opps.admin import widgets as exwidgets
from opps.admin.layout import FormHelper
from opps.admin.models import UserSettings, UserWidget
from opps.admin.sites import site
from opps.admin.views.base import CommAdminView, filter_hook, csrf_protect_m
from opps.admin.views.edit import CreateAdminView
from opps.admin.views.list import ListAdminView
...
class BaseWidget(forms.Form):
    ...
    template = 'opps/admin/widgets/base.html'
...
class ModelChoiceIterator(object):
    ...
    def __iter__(self):
        from opps.admin import site as g_admin_site
...
class QuickBtnWidget(BaseWidget):
    ...
    template = "opps/admin/widgets/qbutton.html"
...
class ListWidget(ModelBaseWidget, PartialBaseWidget):
    ...
    template = "opps/admin/widgets/list.html"
    model_perm = 'view'
...
class AddFormWidget(ModelBaseWidget, PartialBaseWidget):
    ...
    template = "opps/admin/widgets/addform.html"
    model_perm = 'add'
...
class Dashboard(CommAdminView):
    ...
    def get(self, request):
        ...
        return self.template_response('opps/admin/views/dashboard.html', context)
