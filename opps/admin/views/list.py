...
from opps.admin.util import lookup_field, display_for_field, label_for_field, boolean_icon
...
class ListAdminView(ModelAdminView):
        ...
        if (self.show_all and self.can_show_all) or not self.multi_page:
            ...
            try:
                ...
                if ERROR_FLAG in self.request.GET.keys():
                    return SimpleTemplateResponse('opps/admin/views/invalid_setup.html', {
    ...
    # Blocks
    @inclusion_tag('opps/admin/includes/pagination.html')
