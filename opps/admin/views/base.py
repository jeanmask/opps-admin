...
from opps.admin.util import static, json, vendor, sortkeypicker
...
class BaseAdminView(BaseAdminObject, View):
    ...
    base_template = 'opps/admin/base.html'
...
class CommAdminView(BaseAdminView):
    ...
    base_template = 'opps/admin/base_site.html'
    ...
    def get_context(self):
        ...
        context['site_title'] = self.site_title or _(u'Opps Admin')
...
class ModelAdminView(CommAdminView):
    ...
    def get_template_list(self, template_name):
        ...
        return (
            ...
            "opps/admin/%s/%s" % (opts.app_label, template_name),
            "opps/admin/%s" % template_name,
        )
