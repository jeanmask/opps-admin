...
from opps.admin.layout import FormHelper, Layout, Fieldset, Container, Column, Field
from opps.admin.util import unquote, lookup_field, display_for_field, boolean_icon, label_for_field
...
class DetailAdminView(ModelAdminView):
    ...
    def get_media(self):
        ...
        media.add_css({'screen': [self.static('opps/admin/css/xadmin.form.css')]})
        return media
