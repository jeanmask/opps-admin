...
from opps.admin.util import get_model_from_relation, vendor
...
class QuickFormPlugin(BaseAdminPlugin):
    ...
    def init_request(self, *args, **kwargs):
        if self.request.method == 'GET' and self.request.is_ajax() or self.request.GET.get('_ajax'):
            self.admin_view.add_form_template = 'opps/admin/views/quick_form.html'
            self.admin_view.change_form_template = 'opps/admin/views/quick_form.html'
            return True
        return False
