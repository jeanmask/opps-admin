import operator
from opps.admin import widgets

from opps.admin.util import get_fields_from_path, lookup_needs_distinct
...
from opps.admin.filters import manager as filter_manager, FILTER_PREFIX, SEARCH_VAR, DateFieldListFilter, RelatedFieldSearchFilter
from opps.admin.sites import site
from opps.admin.views import BaseAdminPlugin, ListAdminView
...
class FilterPlugin(BaseAdminPlugin):
    ...
    def block_nav_menu(self, context, nodes):
        if self.has_filters:
            nodes.append(loader.render_to_string('opps/admin/blocks/model_list.nav_menu.filters.html', context_instance=context))

    def block_nav_form(self, context, nodes):
        if self.search_fields:
            nodes.append(
                loader.render_to_string(
                    'opps/admin/blocks/model_list.nav_form.search_form.html',
