...
from opps.admin.views import BaseAdminPlugin, ListAdminView, ModelFormAdminView, DetailAdminView
...
class AjaxDetailPlugin(BaseAjaxPlugin):
    ...
    def get_response(self, __):
        if self.request.GET.get('_format') == 'html':
            self.admin_view.detail_template = 'opps/admin/views/quick_detail.html'
            return __()
