...
from opps.admin.views import BaseAdminPlugin, BaseAdminView
from opps.admin.util import static, json

THEME_CACHE_KEY = 'opps_admin__themes'
...
class ThemePlugin(BaseAdminPlugin):
    ...
    default_theme = static('opps/admin/css/themes/bootstrap-xadmin.css')
    ...
    def block_top_navmenu(self, context, nodes):
        ...
        nodes.append(loader.render_to_string('opps/admin/blocks/comm.top.theme.html', {'themes': themes, 'select_css': select_css}))
