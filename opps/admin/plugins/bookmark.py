...
from opps.admin.views import ModelAdminView, BaseAdminPlugin, ListAdminView
from opps.admin.views.list import COL_LIST_VAR, ORDER_VAR
from opps.admin.views.dashboard import widget_manager, BaseWidget, PartialBaseWidget
from opps.admin.filters import FILTER_PREFIX, SEARCH_VAR
from opps.admin.plugins.relate import RELATE_PREFIX

from opps.admin.models import Bookmark
...
class BookmarkPlugin(BaseAdminPlugin):
    ...
    def block_nav_menu(self, context, nodes):
        if self.show_bookmarks:
            nodes.insert(0, loader.render_to_string('opps/admin/blocks/model_list.nav_menu.bookmarks.html', context_instance=context))
