...
from opps.admin.filters import SEARCH_VAR
from opps.admin.views import BaseAdminPlugin, CommAdminView
...
class TopNavPlugin(BaseAdminPlugin):
    ...
    def block_top_navbar(self, context, nodes):
        nodes.append(loader.render_to_string(
            'opps/admin/blocks/comm.top.topnav.html', {"top_navbar": True}))
    ...
    def block_top_navmenu(self, context, nodes):
        ...
        nodes.append(
            loader.render_to_string('opps/admin/blocks/comm.top.topnav.html',
