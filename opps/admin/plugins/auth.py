...
from opps.admin.layout import Fieldset, Main, Side, Row
from opps.admin.sites import site
from opps.admin.util import unquote, User
from opps.admin.views import BaseAdminPlugin, ModelFormAdminView, ModelAdminView, CommAdminView
...
class ChangePasswordView(ModelAdminView):
    ...
    def get_response(self):
        return TemplateResponse(self.request, [
            ...
            'opps/admin/auth/user/change_password.html'
