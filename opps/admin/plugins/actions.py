...
from opps.admin.util import model_format_dict, get_deleted_objects, model_ngettext
from opps.admin.views import BaseAdminPlugin, ListAdminView
from opps.admin.views.base import filter_hook, ModelAdminView
...
class ActionPlugin(BaseAdminPlugin):
    ...
    def block_results_bottom(self, context, nodes):
        if self.actions and self.admin_view.result_count:
            nodes.append(loader.render_to_string('opps/admin/blocks/model_list.results_bottom.actions.html', context_instance=context))
