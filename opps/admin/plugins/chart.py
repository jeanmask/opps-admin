...
from opps.admin.views.dashboard import ModelBaseWidget, widget_manager
from opps.admin.util import lookup_field, label_for_field, json
...
class ChartWidget(ModelBaseWidget):
    ...
    template = 'opps/admin/widgets/chart.html'
...
class ChartsPlugin(BaseAdminPlugin):
    ...
    def block_results_top(self, context, nodes):
        ...
        nodes.append(loader.render_to_string('opps/admin/blocks/model_list.results_top.charts.html', context_instance=context))
