...
from opps.admin.views import BaseAdminPlugin, ModelFormAdminView
...
class WizardFormPlugin(BaseAdminPlugin):
    ...
    def block_before_fieldsets(self, context, nodes):
        ...
        nodes.append(loader.render_to_string('opps/admin/blocks/model_form.before_fieldsets.wizard.html', context_instance=context))
    ...
    def block_submit_line(self, context, nodes):
        ...
        nodes.append(loader.render_to_string('opps/admin/blocks/model_form.submit_line.wizard.html', context_instance=context))
