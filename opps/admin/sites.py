...
class AdminSite(object):
    ...
    def register_modelview(self, path, admin_view_class, name):
        from opps.admin.views.base import BaseAdminView
    ...
    def register_plugin(self, plugin_class, admin_view_class):
        from opps.admin.views.base import BaseAdminPlugin
    ...
    def admin_view(self, view, cacheable=False):
        ...
        def inner(request, *args, **kwargs):
            if not self.has_permission(request):
                ...
                from opps.admin.views import LoginView
    ...
    def get_plugins(self, admin_view_class, *option_classes):
        from opps.admin.views import BaseAdminView
        plugins = []
